...
_G['NemsHubV1 Table'].SizeUi = (not _G['NemsHubV1 Table'].isWindows and UDim2.fromOffset(600,300)) or UDim2.fromOffset(560,600)
...
Teleporting = Tap.location:AddSection('location') do
	-- Teleporting button for "Sunstone Island"
Teleporting:AddButton({
    Title = "Phoenix Rod",
    Callback = function()
